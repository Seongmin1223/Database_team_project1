...
%>
    <h2>Q20: 입찰 경험은 있으나 판매 이력이 없는 사용자 (MINUS)</h2>
    <p>일명 '순수 구매(시도)자' 목록입니다.</p>
    
    <div class="search-box">
        <form action="admin_q20.jsp" method="get">
            사용자 ID 검색: 
...
<%
    ...
    String sql = "SELECT BR.BidderID AS UserID "
               + "FROM BIDDING_RECORD BR "
               + "WHERE BR.BidderID LIKE ? "
               + "MINUS "
               + "SELECT T.SellerID AS UserID "
               + "FROM TRANSACTION T";
